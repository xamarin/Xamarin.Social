...
namespace Xamarin.Social.Utilities
{
    /// <summary>
    /// Web extensions methods from Xamarin.Auth moved into different namespace.
    /// </summary>
    public static class WebEx
    {
		...
		*/
        ...
        public static Dictionary<string, string> JsonDecode(string encodedString)
        {
            ...
            {
                var v = kv.Value as System.Json.JsonValue;
                if (v != null)
                {
                    if (v.JsonType != System.Json.JsonType.String)
